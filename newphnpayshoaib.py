...
path="F:/DATA SCIENCE PROJECTS/capstone 2/pulse/data/aggregated/transaction/country/india/state/"
...
#Aggregated User
path1="F:/DATA SCIENCE PROJECTS/capstone 2/pulse/data/aggregated/user/country/india/state/"
...
# Map Transaction
path2="F:/DATA SCIENCE PROJECTS/capstone 2/pulse/data/map/transaction/hover/country/india/state/"
...
#Map User
path3="F:/DATA SCIENCE PROJECTS/capstone 2/pulse/data/map/user/hover/country/india/state/"
...
# TOP Transaction
path4="F:/DATA SCIENCE PROJECTS/capstone 2/pulse/data/top/transaction/country/india/state/"
...
path5="F:/DATA SCIENCE PROJECTS/capstone 2/pulse/data/top/user/country/india/state/"
...
st.set_page_config(page_title="Shoaib's PhonePe Data", page_icon="📊", layout="wide")
st.title("Shoaib's PhonePe Data Visualization and Exploration")
...
if select == "Welcome":
    # Create a single tab for PhonePe Info Page
    tab1, = st.tabs(["PhonePe Info Page"])
    with tab1:
        # Create columns for better alignment of content
        col1, col2 = st.columns(2)
        
        with col1:
            # Add a styled header and subheader
            st.markdown("<h1 style='color: #4CAF50;'>PhonePe</h1>", unsafe_allow_html=True)
            st.markdown("<h3 style='color: #008CBA;'>India's Best Transaction App</h3>", unsafe_allow_html=True)
            
            # Description and Features with Markdown for better formatting
            st.markdown("""
                **PhonePe** is an Indian digital payments and financial technology company that enables seamless and secure transactions.

                ### **FEATURES**
                - Credit Card and Debit Card Linking
                - Bank Balance Check
                - Money Storage
                - Pin Authorization
            """)
            
            # Download Button with padding for better design
            st.markdown("<br>", unsafe_allow_html=True)
            st.download_button("DOWNLOAD THE APP NOW", "https://www.phonepe.com/app-download/")
        
        with col2:
            # Display Image with appropriate error handling
            file_path = r"C:\Users\SHOAIB\OneDrive\Pictures\Screenshots\Desktop\Capstone 2\Phonepayimage.jfif"  # Use relative path or general path
            if os.path.exists(file_path):
                st.image(Image.open(file_path), width=400)  # Adjust the image width for better fit
            else:
